...
typedef void (*IoTNumericCallback)(int value);
...
private:
    ...
    std::map<String, IoTNumericCallback> _numericCallbacks;
...
public:
    ...
    void registerNumericCallback(const char* pin, IoTNumericCallback callback) {
